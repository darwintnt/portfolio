  ...
  >
    <div class="container mx-auto px-6 relative z-10">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <h2
          class="text-2xl md:text-4xl font-semibold text-muted-foreground mb-6 animate-slide-up"
        ...
        <div
          class="flex flex-wrap items-center justify-center gap-4 mb-12 animate-slide-up"
        ...
        <!-- Social Links -->
        <div
          class="flex items-center justify-center gap-6 animate-slide-up"
