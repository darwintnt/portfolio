    ...
    <div class="container mx-auto px-6 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-6xl mx-auto">
        ...
        <div class="lg:col-span-7 text-left">
          <p
            class="font-accent text-2xl md:text-3xl text-accent inline-flex items-center gap-2 bg-soft-accent/15 border border-soft-accent/20 rounded-full px-5 py-1.5 mb-8 animate-slide-up"
          >
            {{ t('hero.openToWork') }}
          </p>
        ...
        <!-- Visual column (right, large screens only) -->
        <div class="hidden lg:block lg:col-span-5 animate-slide-up" :style="{ animationDelay: '0.3s' }">
