        ...
        <div class="flex flex-col justify-center items-center mt-8 gap-2">
          ...
          <div class="flex flex-col md:flex-row gap-2 my-4 items-center">
            <div class="flex justify-start items-center">
              <a
                class="flex items-center align-middle justify-center bg-linear-to-br from-blue-400 to-purple-600 rounded-lg transition-all duration-300 ease-in-out overflow-hidden shadow-lg shadow-blue-400/30 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-400/40 p-4 gap-3 text-lg w-full md:w-60"
